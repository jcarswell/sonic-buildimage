...
def main():
    thermal = ThermalUtil()
    print("thermal1=%d" %thermal._get_thermal_val(1))
    print("thermal2=%d" %thermal._get_thermal_val(2))
    print("thermal3=%d" %thermal._get_thermal_val(3))
    print("thermal4=%d" %thermal._get_thermal_val(4))   
#
